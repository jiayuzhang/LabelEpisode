...
?>
			<?php if( apply_filters( 'wcfm_is_allow_inventory', true ) && apply_filters( 'wcfm_is_allow_pm_inventory', true ) ) { ?>
					...
					<div class="wcfm-container simple variable grouped external non-job_package non-resume_package non-auction non-groupbuy non-accommodation-booking <?php echo apply_filters( 'wcfm_pm_block_custom_class_stock', '' ); ?>">
				...
				<?php if( apply_filters( 'wcfmu_is_allow_downloadable', true ) && apply_filters( 'wcfmu_is_allow_pm_downloadable', true ) ) { ?>
					<!-- collapsible 2 -->
					<div class="page_collapsible products_manage_downloadable simple downlodable non-variable-subscription non-redq_rental non-appointment" id="wcfm_products_manage_form_downloadable_head"><label class="wcfmfa fa-cloud-download-alt"></label><?php _e('Downloadable', 'wc-frontend-manager'); ?><span></span></div>
				...
				<!-- collapsible 4 -->
				<div class="page_collapsible products_manage_shipping <?php echo apply_filters( 'wcfm_pm_block_class_shipping', 'simple variable nonvirtual booking non-accommodation-booking' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_shipping', '' ); ?>" id="wcfm_products_manage_form_shipping_head"><label class="wcfmfa fa-truck"></label><?php _e('Shipping', 'wc-frontend-manager'); ?><span></span></div>
				...
				<!-- collapsible 5 -->
				<div class="page_collapsible products_manage_tax <?php echo apply_filters( 'wcfm_pm_block_class_tax', 'simple variable non-groupbuy' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>" id="wcfm_products_manage_form_tax_head"><label class="wcfmfa fa-money fa-money-bill-alt"></label><?php _e('Tax', 'wc-frontend-manager'); ?><span></span></div>
				<div class="wcfm-container simple variable non-groupbuy <?php echo apply_filters( 'wcfm_pm_block_custom_class_tax', '' ); ?>">
				...
				<!-- collapsible 7 -->
				<div class="page_collapsible products_manage_variations variable variations variable-subscription" id="wcfm_products_manage_form_variations_head"><label class="wcfmfa fa-tasks"></label><?php _e('Variations', 'wc-frontend-manager'); ?><span></span></div>
					  ...
					  <p>
						...
						<?php
						 ...
						 $WCFM->wcfm_fields->wcfm_generate_form_field( array(
								"variations" => array(
									'type' => 'multiinput',
									'class' => 'wcfm_ele variable variable-subscription',
									'label_class' => 'wcfm_title',
									'value' => $variations,
									'options' => apply_filters( 'wcfm_product_manage_fields_variations', array(
										...
										"enable" => array(
											...
											'value' => 'enable',
											'dfvalue' => 'enable',
											'class' => 'wcfm-checkbox wcfm_ele variable variable-subscription',
											'label_class' => 'wcfm_title checkbox_title'),
										// Virtual checkbox
										"is_virtual" => array(
											'label' => __('Virtual', 'wc-frontend-manager'),
											'type' => 'checkbox',
											'value' => 'enable',
											'class' => 'wcfm-checkbox wcfm_ele variable variable-subscription variation_is_virtual_ele',
											'label_class' => 'wcfm_title checkbox_title'),
										// "Manage Stock" checkbox
										"manage_stock" => array(
											'label' => __('Manage Stock', 'wc-frontend-manager'),
											'type' => 'checkbox',
											'value' => 'enable',
											'value' => 'enable',
											'class' => 'wcfm-checkbox wcfm_ele variable variable-subscription variation_manage_stock_ele',
											'label_class' => 'wcfm_title checkbox_title'),
										// HTML
										"wcfm_element_breaker_variation_1" => array(
											'type' => 'html',
											'value' => '<div class="wcfm-cearfix"></div>'),
										// Images
										"image" => array(
										...
										// Regular Price
										"regular_price" => array(
											'label' => __('Regular Price', 'wc-frontend-manager') . '(' . get_woocommerce_currency_symbol() . ')',
											'type' => 'number',
				...
				<?php if( $allow_advanced = apply_filters( 'wcfm_is_allow_linked', true ) ) { ?>
					...
					<div class="page_collapsible products_manage_linked <?php echo apply_filters( 'wcfm_pm_block_class_linked', 'simple variable external grouped' ); ?> <?php echo apply_filters( 'wcfm_pm_block_custom_class_linked', '' ); ?>" id="wcfm_products_manage_form_linked_head"><label class="wcfmfa fa-link"></label><?php _e('Linked', 'wc-frontend-manager'); ?><span></span></div>
