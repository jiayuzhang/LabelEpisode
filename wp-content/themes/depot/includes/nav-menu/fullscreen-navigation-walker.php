...
if (!class_exists('DepotMikadoFullscreenNavigationWalker')) {
	class DepotMikadoFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<i class="mkd-fullscreen-menu-arrow mkd-icon-font-elegant arrow_triangle-down"></i>';
				}
				$item_output .= '</a>';
			}
