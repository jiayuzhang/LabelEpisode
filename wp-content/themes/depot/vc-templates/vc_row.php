...
$row_content_width = $anchor = $content_text_aligment = $mkd_row_wrapper_start = $mkd_row_wrapper_end = '';
...
if (!empty($content_text_aligment)){
	$css_classes[] = 'mkd-content-aligment-' . $content_text_aligment;
}
...
if($row_content_width === 'grid'){
	$mkd_row_wrapper_start .= '<div class="mkd-row-grid-section">';
	$mkd_row_wrapper_end .= '</div>';
}
