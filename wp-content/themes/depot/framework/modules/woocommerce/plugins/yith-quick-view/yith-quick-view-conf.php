...
add_action( 'yith_wcqv_product_summary', 'depot_mikado_woocommerce_yith_template_single_title', 5 );
...
add_action('yith_wcqv_product_image', 'depot_mikado_woocommerce_show_product_images', 9);

//Add yith quick view button
add_action( 'depot_mikado_woo_pl_info_below_image', 'depot_mikado_woocommerce_quickview_link', 2 );
...
add_action('yith_wcqv_product_summary', 'depot_mikado_woocommerce_share_wish_tag_before', 30);
add_action('yith_wcqv_product_summary', 'depot_mikado_woocommerce_share_wish_tag_after', 35);
...
add_action( 'yith_wcqv_product_summary', 'depot_mikado_woocommerce_share', 32 );
