...
<div class="mkd-title <?php echo depot_mikado_title_classes(); ?>" style="<?php echo esc_attr(is_brand_page() ? 'height:inherit' : $title_height); echo esc_attr($title_background_color); echo esc_attr($title_background_image); ?>" data-height="<?php echo esc_attr(intval(preg_replace('/[^0-9]+/', '', $title_height), 10));?>" <?php echo esc_attr($title_background_image_width); ?>>
                        ...
                        <?php switch ($type){
                            case 'standard': ?>
                                <?php if(is_brand_page()) { ?>
                                  <<?php echo esc_attr($title_tag); ?> class="mkd-page-title entry-title" <?php depot_mikado_inline_style($title_color); ?>><span><?php woocommerce_page_title(); ?></span></<?php echo esc_attr($title_tag); ?>>
                                  <?php do_action('woocommerce_archive_description'); ?>
                                <?php } else if(depot_mikado_get_title_text() !== '') { ?>
